...
📖 About section with a short intro to the show
💬 Iconic quotes strip
🎭 Character cards for all 6 main cast members
...
Centered logo      justify-between + spacer div
Responsive cards   grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3
Pill badges        rounded-full px-4 py-1
Dark section       bg-amber-700 text-white
...
Building a responsive grid with sm: and lg: breakpoints
